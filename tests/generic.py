...
dat=fits.open("/home/conor/dat/NGC346/JWST/stage2-destriped/de-striped_F444W/de-striped_jw01227002001_02105_00001_nrcalong_cal.fits")
...
ax1.imshow(ZScaleInterval()(image))
ax2.imshow(ZScaleInterval()(conv))
ax3.imshow(ZScaleInterval()(corr))
